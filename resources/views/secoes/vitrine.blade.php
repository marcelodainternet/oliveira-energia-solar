    ...
    <div class="portfolio-details-slider swiper">
        ...
        @foreach ($vitrine->postagens as $postagem)
            ...
            <div class="carousel-container carousel-item">
                ...
                <a target="_blank" href="https://api.whatsapp.com/send?phone=55{{$configuracao['telefone']}}&text={{$configuracao['whatstxt']}}" class="btn-get-started scrollto animate__animated animate__fadeInUp">
                    Saber mais...
                    <img src="{{asset('assets/img/icon-whats.gif')}}" width="30" class="d-md-none" style="margin-left:10px; margin-top:-10px;" data-aos="fade-left">
                    </a>
                </div>
            </div>
            </div>
