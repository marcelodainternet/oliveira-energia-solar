<section id="vitrines2" class="vitrines2e3" style='background: url("uploads/secao-{{$vitrine2->id}}.jpg") center center no-repeat; background-size:cover; margin-bottom:75px;'>
