<header id="header" class="fixed-top d-flex align-items-center section-bg">
    <div class="container d-flex align-items-center justify-content-between">
        <div class="logo">
            ...
            <a target="_blank" href="https://api.whatsapp.com/send?phone=55<?php echo $configuracao['telefone']; ?>&text=<?php echo $configuracao['whatstxt']; ?>">
                <img src="assets/img/icon-whats.gif" width="42" class="d-md-none" style="margin-left:40px; margin-top:-7px; " data-aos="fade-left">
            </a>
        </div>
        <nav id="navbar" class="navbar">
            <ul>
            <li><a class="nav-link scrollto active" href="./#vitrine">Home</a></li>
            <li><a class="nav-link scrollto" href="./#home">Energia Solar</a></li>
            <li><a class="nav-link scrollto " href="./#portfolio">Portfolio</a></li>
            <li><a class="nav-link scrollto" href="./#empresa">Quem Somos</a></li>
