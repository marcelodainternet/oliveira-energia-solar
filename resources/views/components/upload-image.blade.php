<div class="carregamento-de-imagem" data-fallback="{{$fallback}}" style="position: relative; display:inline-block;">
    <label for="f{{$name}}">
      <img class="img-thumbnail" style="width: 225px; height: 150px; object-fit:contain;" src="{{isset($path) && file_exists(public_path($path))?asset($path):$fallback}}" alt="Imagem Principal" title="Imagem Principal">
    </label>
