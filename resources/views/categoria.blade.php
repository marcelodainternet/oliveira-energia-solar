        ...
        <div class="row portfolio-container justify-content-center">
          @foreach ($categoria->subcategorias as $subcategoria)
            <div class="col-lg-4 portfolio-item <?php echo $subcategoria->titulo ?>">
              <a href="{{asset('uploads/projeto-foto-'.$subcategoria->id.'-grande.jpg')}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?php echo $subcategoria->titulo ?> - <?php echo $subcategoria->subtitulo ?>">
